...
# Title: Run Rootmusic Lin Array Simulation
# Generated: Thu Aug 23 16:35:18 2018
##################################################
...
class run_RootMUSIC_lin_array_simulation(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Run Rootmusic Lin Array Simulation")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Run Rootmusic Lin Array Simulation")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "run_RootMUSIC_lin_array_simulation")
        ...
        self.input_variables = input_variables = struct({'SampleRate': 320000, 'ToneFreq1': 10000, 'ToneFreq2': 20000, 'NumTargets': 2, 'NumArrayElements': 4, 'NormSpacing': 0.44, 'PSpectrumLength': 2**10, 'SnapshotSize': 2**11, 'OverlapSize': 2**9, })
...
def main(top_block_cls=run_RootMUSIC_lin_array_simulation, options=None):
