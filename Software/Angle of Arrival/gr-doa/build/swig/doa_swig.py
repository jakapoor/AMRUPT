...
class autocorrelate_smoothing(object):
    """Proxy of C++ gr::doa::autocorrelate_smoothing class."""
    ...
    def make(inputs, snapshot_size, overlap_size, avg_method, subspace_smoothing, subarray_size):
        """make(int inputs, int snapshot_size, int overlap_size, int avg_method, int subspace_smoothing, int subarray_size) -> autocorrelate_smoothing_sptr"""
        return _doa_swig.autocorrelate_smoothing_make(inputs, snapshot_size, overlap_size, avg_method, subspace_smoothing, subarray_size)

    make = staticmethod(make)
    __swig_destroy__ = _doa_swig.delete_autocorrelate_smoothing
    __del__ = lambda self: None
autocorrelate_smoothing_swigregister = _doa_swig.autocorrelate_smoothing_swigregister
autocorrelate_smoothing_swigregister(autocorrelate_smoothing)

def autocorrelate_smoothing_make(inputs, snapshot_size, overlap_size, avg_method, subspace_smoothing, subarray_size):
    """autocorrelate_smoothing_make(int inputs, int snapshot_size, int overlap_size, int avg_method, int subspace_smoothing, int subarray_size) -> autocorrelate_smoothing_sptr"""
    return _doa_swig.autocorrelate_smoothing_make(inputs, snapshot_size, overlap_size, avg_method, subspace_smoothing, subarray_size)

class autocorrelate_smoothing_sptr(object):
    """Proxy of C++ boost::shared_ptr<(gr::doa::autocorrelate_smoothing)> class."""
    ...
    def __init__(self, *args):
        """
        __init__(boost::shared_ptr<(gr::doa::autocorrelate_smoothing)> self) -> autocorrelate_smoothing_sptr
        __init__(boost::shared_ptr<(gr::doa::autocorrelate_smoothing)> self, autocorrelate_smoothing p) -> autocorrelate_smoothing_sptr
        """
        this = _doa_swig.new_autocorrelate_smoothing_sptr(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def __deref__(self):
        """__deref__(autocorrelate_smoothing_sptr self) -> autocorrelate_smoothing"""
        return _doa_swig.autocorrelate_smoothing_sptr___deref__(self)

    __swig_destroy__ = _doa_swig.delete_autocorrelate_smoothing_sptr
    __del__ = lambda self: None

    def make(self, inputs, snapshot_size, overlap_size, avg_method, subspace_smoothing, subarray_size):
        """make(autocorrelate_smoothing_sptr self, int inputs, int snapshot_size, int overlap_size, int avg_method, int subspace_smoothing, int subarray_size) -> autocorrelate_smoothing_sptr"""
        return _doa_swig.autocorrelate_smoothing_sptr_make(self, inputs, snapshot_size, overlap_size, avg_method, subspace_smoothing, subarray_size)


    def history(self):
        """history(autocorrelate_smoothing_sptr self) -> unsigned int"""
        return _doa_swig.autocorrelate_smoothing_sptr_history(self)


    def declare_sample_delay(self, *args):
        """
        declare_sample_delay(autocorrelate_smoothing_sptr self, int which, int delay)
        declare_sample_delay(autocorrelate_smoothing_sptr self, unsigned int delay)
        """
        return _doa_swig.autocorrelate_smoothing_sptr_declare_sample_delay(self, *args)


    def sample_delay(self, which):
        """sample_delay(autocorrelate_smoothing_sptr self, int which) -> unsigned int"""
        return _doa_swig.autocorrelate_smoothing_sptr_sample_delay(self, which)


    def output_multiple(self):
        """output_multiple(autocorrelate_smoothing_sptr self) -> int"""
        return _doa_swig.autocorrelate_smoothing_sptr_output_multiple(self)


    def relative_rate(self):
        """relative_rate(autocorrelate_smoothing_sptr self) -> double"""
        return _doa_swig.autocorrelate_smoothing_sptr_relative_rate(self)


    def start(self):
        """start(autocorrelate_smoothing_sptr self) -> bool"""
        return _doa_swig.autocorrelate_smoothing_sptr_start(self)


    def stop(self):
        """stop(autocorrelate_smoothing_sptr self) -> bool"""
        return _doa_swig.autocorrelate_smoothing_sptr_stop(self)


    def nitems_read(self, which_input):
        """nitems_read(autocorrelate_smoothing_sptr self, unsigned int which_input) -> uint64_t"""
        return _doa_swig.autocorrelate_smoothing_sptr_nitems_read(self, which_input)


    def nitems_written(self, which_output):
        """nitems_written(autocorrelate_smoothing_sptr self, unsigned int which_output) -> uint64_t"""
        return _doa_swig.autocorrelate_smoothing_sptr_nitems_written(self, which_output)


    def max_noutput_items(self):
        """max_noutput_items(autocorrelate_smoothing_sptr self) -> int"""
        return _doa_swig.autocorrelate_smoothing_sptr_max_noutput_items(self)


    def set_max_noutput_items(self, m):
        """set_max_noutput_items(autocorrelate_smoothing_sptr self, int m)"""
        return _doa_swig.autocorrelate_smoothing_sptr_set_max_noutput_items(self, m)


    def unset_max_noutput_items(self):
        """unset_max_noutput_items(autocorrelate_smoothing_sptr self)"""
        return _doa_swig.autocorrelate_smoothing_sptr_unset_max_noutput_items(self)


    def is_set_max_noutput_items(self):
        """is_set_max_noutput_items(autocorrelate_smoothing_sptr self) -> bool"""
        return _doa_swig.autocorrelate_smoothing_sptr_is_set_max_noutput_items(self)


    def set_min_noutput_items(self, m):
        """set_min_noutput_items(autocorrelate_smoothing_sptr self, int m)"""
        return _doa_swig.autocorrelate_smoothing_sptr_set_min_noutput_items(self, m)


    def min_noutput_items(self):
        """min_noutput_items(autocorrelate_smoothing_sptr self) -> int"""
        return _doa_swig.autocorrelate_smoothing_sptr_min_noutput_items(self)


    def max_output_buffer(self, i):
        """max_output_buffer(autocorrelate_smoothing_sptr self, int i) -> long"""
        return _doa_swig.autocorrelate_smoothing_sptr_max_output_buffer(self, i)


    def set_max_output_buffer(self, *args):
        """
        set_max_output_buffer(autocorrelate_smoothing_sptr self, long max_output_buffer)
        set_max_output_buffer(autocorrelate_smoothing_sptr self, int port, long max_output_buffer)
        """
        return _doa_swig.autocorrelate_smoothing_sptr_set_max_output_buffer(self, *args)


    def min_output_buffer(self, i):
        """min_output_buffer(autocorrelate_smoothing_sptr self, int i) -> long"""
        return _doa_swig.autocorrelate_smoothing_sptr_min_output_buffer(self, i)


    def set_min_output_buffer(self, *args):
        """
        set_min_output_buffer(autocorrelate_smoothing_sptr self, long min_output_buffer)
        set_min_output_buffer(autocorrelate_smoothing_sptr self, int port, long min_output_buffer)
        """
        return _doa_swig.autocorrelate_smoothing_sptr_set_min_output_buffer(self, *args)


    def pc_noutput_items(self):
        """pc_noutput_items(autocorrelate_smoothing_sptr self) -> float"""
        return _doa_swig.autocorrelate_smoothing_sptr_pc_noutput_items(self)


    def pc_noutput_items_avg(self):
        """pc_noutput_items_avg(autocorrelate_smoothing_sptr self) -> float"""
        return _doa_swig.autocorrelate_smoothing_sptr_pc_noutput_items_avg(self)


    def pc_noutput_items_var(self):
        """pc_noutput_items_var(autocorrelate_smoothing_sptr self) -> float"""
        return _doa_swig.autocorrelate_smoothing_sptr_pc_noutput_items_var(self)


    def pc_nproduced(self):
        """pc_nproduced(autocorrelate_smoothing_sptr self) -> float"""
        return _doa_swig.autocorrelate_smoothing_sptr_pc_nproduced(self)


    def pc_nproduced_avg(self):
        """pc_nproduced_avg(autocorrelate_smoothing_sptr self) -> float"""
        return _doa_swig.autocorrelate_smoothing_sptr_pc_nproduced_avg(self)


    def pc_nproduced_var(self):
        """pc_nproduced_var(autocorrelate_smoothing_sptr self) -> float"""
        return _doa_swig.autocorrelate_smoothing_sptr_pc_nproduced_var(self)


    def pc_input_buffers_full(self, *args):
        """
        pc_input_buffers_full(autocorrelate_smoothing_sptr self, int which) -> float
        pc_input_buffers_full(autocorrelate_smoothing_sptr self) -> pmt_vector_float
        """
        return _doa_swig.autocorrelate_smoothing_sptr_pc_input_buffers_full(self, *args)


    def pc_input_buffers_full_avg(self, *args):
        """
        pc_input_buffers_full_avg(autocorrelate_smoothing_sptr self, int which) -> float
        pc_input_buffers_full_avg(autocorrelate_smoothing_sptr self) -> pmt_vector_float
        """
        return _doa_swig.autocorrelate_smoothing_sptr_pc_input_buffers_full_avg(self, *args)


    def pc_input_buffers_full_var(self, *args):
        """
        pc_input_buffers_full_var(autocorrelate_smoothing_sptr self, int which) -> float
        pc_input_buffers_full_var(autocorrelate_smoothing_sptr self) -> pmt_vector_float
        """
        return _doa_swig.autocorrelate_smoothing_sptr_pc_input_buffers_full_var(self, *args)


    def pc_output_buffers_full(self, *args):
        """
        pc_output_buffers_full(autocorrelate_smoothing_sptr self, int which) -> float
        pc_output_buffers_full(autocorrelate_smoothing_sptr self) -> pmt_vector_float
        """
        return _doa_swig.autocorrelate_smoothing_sptr_pc_output_buffers_full(self, *args)


    def pc_output_buffers_full_avg(self, *args):
        """
        pc_output_buffers_full_avg(autocorrelate_smoothing_sptr self, int which) -> float
        pc_output_buffers_full_avg(autocorrelate_smoothing_sptr self) -> pmt_vector_float
        """
        return _doa_swig.autocorrelate_smoothing_sptr_pc_output_buffers_full_avg(self, *args)


    def pc_output_buffers_full_var(self, *args):
        """
        pc_output_buffers_full_var(autocorrelate_smoothing_sptr self, int which) -> float
        pc_output_buffers_full_var(autocorrelate_smoothing_sptr self) -> pmt_vector_float
        """
        return _doa_swig.autocorrelate_smoothing_sptr_pc_output_buffers_full_var(self, *args)


    def pc_work_time(self):
        """pc_work_time(autocorrelate_smoothing_sptr self) -> float"""
        return _doa_swig.autocorrelate_smoothing_sptr_pc_work_time(self)


    def pc_work_time_avg(self):
        """pc_work_time_avg(autocorrelate_smoothing_sptr self) -> float"""
        return _doa_swig.autocorrelate_smoothing_sptr_pc_work_time_avg(self)


    def pc_work_time_var(self):
        """pc_work_time_var(autocorrelate_smoothing_sptr self) -> float"""
        return _doa_swig.autocorrelate_smoothing_sptr_pc_work_time_var(self)


    def pc_work_time_total(self):
        """pc_work_time_total(autocorrelate_smoothing_sptr self) -> float"""
        return _doa_swig.autocorrelate_smoothing_sptr_pc_work_time_total(self)


    def pc_throughput_avg(self):
        """pc_throughput_avg(autocorrelate_smoothing_sptr self) -> float"""
        return _doa_swig.autocorrelate_smoothing_sptr_pc_throughput_avg(self)


    def set_processor_affinity(self, mask):
        """set_processor_affinity(autocorrelate_smoothing_sptr self, std::vector< int,std::allocator< int > > const & mask)"""
        return _doa_swig.autocorrelate_smoothing_sptr_set_processor_affinity(self, mask)


    def unset_processor_affinity(self):
        """unset_processor_affinity(autocorrelate_smoothing_sptr self)"""
        return _doa_swig.autocorrelate_smoothing_sptr_unset_processor_affinity(self)


    def processor_affinity(self):
        """processor_affinity(autocorrelate_smoothing_sptr self) -> std::vector< int,std::allocator< int > >"""
        return _doa_swig.autocorrelate_smoothing_sptr_processor_affinity(self)


    def active_thread_priority(self):
        """active_thread_priority(autocorrelate_smoothing_sptr self) -> int"""
        return _doa_swig.autocorrelate_smoothing_sptr_active_thread_priority(self)


    def thread_priority(self):
        """thread_priority(autocorrelate_smoothing_sptr self) -> int"""
        return _doa_swig.autocorrelate_smoothing_sptr_thread_priority(self)


    def set_thread_priority(self, priority):
        """set_thread_priority(autocorrelate_smoothing_sptr self, int priority) -> int"""
        return _doa_swig.autocorrelate_smoothing_sptr_set_thread_priority(self, priority)


    def name(self):
        """name(autocorrelate_smoothing_sptr self) -> std::string"""
        return _doa_swig.autocorrelate_smoothing_sptr_name(self)


    def symbol_name(self):
        """symbol_name(autocorrelate_smoothing_sptr self) -> std::string"""
        return _doa_swig.autocorrelate_smoothing_sptr_symbol_name(self)


    def input_signature(self):
        """input_signature(autocorrelate_smoothing_sptr self) -> io_signature_sptr"""
        return _doa_swig.autocorrelate_smoothing_sptr_input_signature(self)


    def output_signature(self):
        """output_signature(autocorrelate_smoothing_sptr self) -> io_signature_sptr"""
        return _doa_swig.autocorrelate_smoothing_sptr_output_signature(self)


    def unique_id(self):
        """unique_id(autocorrelate_smoothing_sptr self) -> long"""
        return _doa_swig.autocorrelate_smoothing_sptr_unique_id(self)


    def to_basic_block(self):
        """to_basic_block(autocorrelate_smoothing_sptr self) -> basic_block_sptr"""
        return _doa_swig.autocorrelate_smoothing_sptr_to_basic_block(self)


    def check_topology(self, ninputs, noutputs):
        """check_topology(autocorrelate_smoothing_sptr self, int ninputs, int noutputs) -> bool"""
        return _doa_swig.autocorrelate_smoothing_sptr_check_topology(self, ninputs, noutputs)


    def alias(self):
        """alias(autocorrelate_smoothing_sptr self) -> std::string"""
        return _doa_swig.autocorrelate_smoothing_sptr_alias(self)


    def set_block_alias(self, name):
        """set_block_alias(autocorrelate_smoothing_sptr self, std::string name)"""
        return _doa_swig.autocorrelate_smoothing_sptr_set_block_alias(self, name)


    def _post(self, which_port, msg):
        """_post(autocorrelate_smoothing_sptr self, swig_int_ptr which_port, swig_int_ptr msg)"""
        return _doa_swig.autocorrelate_smoothing_sptr__post(self, which_port, msg)


    def message_ports_in(self):
        """message_ports_in(autocorrelate_smoothing_sptr self) -> swig_int_ptr"""
        return _doa_swig.autocorrelate_smoothing_sptr_message_ports_in(self)


    def message_ports_out(self):
        """message_ports_out(autocorrelate_smoothing_sptr self) -> swig_int_ptr"""
        return _doa_swig.autocorrelate_smoothing_sptr_message_ports_out(self)


    def message_subscribers(self, which_port):
        """message_subscribers(autocorrelate_smoothing_sptr self, swig_int_ptr which_port) -> swig_int_ptr"""
        return _doa_swig.autocorrelate_smoothing_sptr_message_subscribers(self, which_port)

autocorrelate_smoothing_sptr_swigregister = _doa_swig.autocorrelate_smoothing_sptr_swigregister
autocorrelate_smoothing_sptr_swigregister(autocorrelate_smoothing_sptr)


autocorrelate_smoothing_sptr.__repr__ = lambda self: "<gr_block %s (%d)>" % (self.name(), self.unique_id())
autocorrelate_smoothing = autocorrelate_smoothing.make;
